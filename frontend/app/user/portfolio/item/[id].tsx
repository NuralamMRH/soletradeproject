...
import { usePortfolioProduct } from "@/hooks/usePortfolio";
import PortfolioDetails from "@/components/product/PortfolioDetails";
...
export default function ProductDetailsScreen() {
  ...
  const {
    ...
    error,
    refetch,
  } = usePortfolioProduct(id as string);
  ...
  return (
    <View style={styles.container}>
      <PortfolioDetails portfolio={portfolioData} product={productData} />
    </View>
  );
}

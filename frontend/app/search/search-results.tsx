...
export default function SearchResultsPage() {
  ...
  const queryFilter = { keyword: query, ...newFilter, ...filterObj };
  ...
  const handleSave = () => {
    let productsArray: ProductCardProps[] = [];
    if (Array.isArray(products)) {
      productsArray = products;
    } else if (products && Array.isArray((products as any).products)) {
      productsArray = (products as any).products;
    }
          ...
          >
            ...
            {searchFor === "columnSelection" && (
              ...
              >
                <Ionicons
                  name={
                    selectedIds.includes(productId) ? "checkmark-circle" : "add"
                  }
                  size={20}
                  color="#000"
                />

...
export default function AllBrandsManagePage() {
  const router = useRouter();
  const paramsRaw = useLocalSearchParams();
  const parentBrandId =
    typeof paramsRaw.parentBrandId === "string"
      ? paramsRaw.parentBrandId
      : null;
  ...
  const loading = isSubBrand ? subBrand.loading : bra.loading;
  const error = isSubBrand ? subBrand.error : bra.error;
  const refetch = isSubBrand ? subBrand.refetch : bra.refetch;
  ...
  const handleAddNewBrand = () => {
    router.push({
      pathname: "/admin/brands/add-new-brand",
      params: { isSubBrand: isSubBrand.toString() },
    });
  };
  ...
  const handleEditBrand = (brand: any) => {
    router.push({
      ...
      params: {
        ...
        isSubBrand: isSubBrand.toString(),
      },
    });
  };
        ...
        ListHeaderComponent={
          ...
          >
            <Text style={styles.title}>
              {isSubBrand ? "Manage Sub Brand" : "Manage Brand"}
            </Text>
            <TouchableOpacity
              style={{
                flexDirection: "row",
